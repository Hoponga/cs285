...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        # HINT: the replay buffer used here is `MemoryOptimizedReplayBuffer`
            # in dqn_utils.py
        # so we have stored the last observation (aka the last FRAME) into the replay buffer by appendin the frame to the internal data structure 
        ...
        if perform_random_action:
            ...
            # we dynamically reconstruct the last "actual observation" which is a concatenation of the last <= frame_history_len frames
            # in the replay buffer 
            actual_obs = self.replay_buffer.encode_recent_observation() 
